...
def create_cluster(region_name, cluster_name='Airflow-' + str(datetime.now()), release_label='emr-5.20.0',master_instance_type='m5a.xlarge', num_core_nodes=2, core_node_instance_type='m5a.xlarge'):
